...
public class MaterialDialogUtils {
    ...
    public void showThemed(Context context, String
        ...
        new MaterialDialog.Builder(context)
                ...
                .positiveColorRes(R.color.colorPureWhite)
                .negativeColorRes(R.color.colorPureWhite)
                .titleGravity(GravityEnum.CENTER)
                .titleColorRes(R.color.colorPureWhite)
                .contentColorRes(android.R.color.white)
                .backgroundColorRes(R.color.material_blue_grey_800)
                .dividerColorRes(R.color.colorPureWhite)
...
//        });
    ...
    public static MaterialDialog.Builder showIndeterminateProgressDialog(Context context, String content, boolean horizontal) {
        MaterialDialog.Builder builder = new MaterialDialog.Builder(context)
                ...
                .backgroundColorRes(R.color.colorPureWhite)
